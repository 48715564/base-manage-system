...
public final class JwtUserFactory {
    ...
    public static JwtUser create(SysUser sysUser) {
        return new JwtUser(sysUser, mapToGrantedAuthorities(sysUser.getMenuList()));
    }

    private static List<GrantedAuthority> mapToGrantedAuthorities(List<SysMenu> authorities) {
        if(authorities!=null) {
