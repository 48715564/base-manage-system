 ...
 */
@Service
public class SysUserService extends CrudService<SysUserMapper,SysUser,SysUserExample,java.lang.String> {
    ...
    public SysUser getUserByUserName(String username) {
        ...
        if(sysUser!=null) {
            sysUser.setRoleList(sysRoleService.getRoleByUserId(sysUser.getId()));
            sysUser.setMenuList(sysMenuService.getMenuByUserID(sysUser.getId()));
        }
        return sysUser;
    }
