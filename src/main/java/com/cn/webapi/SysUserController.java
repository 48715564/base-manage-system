...
public class SysUserController {
    ...
    public AjaxResponse<SysUser> getSysUser(@ApiParam(value = "用户token", required = true) @RequestHeader("token") String token, @PathVariable java.lang.String id){
        try {
    ...
    public AjaxResponse<String> deleteSysUser(@ApiParam(value = "用户token", required = true) @RequestHeader("token") String token, @PathVariable java.lang.String id){
        try {
